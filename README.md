...
이 저장소는 퍼블릭 저장소이기 때문에, 관리자 평문 키와 실제 해시값은 문서나 코드에 기록하지 않습니다. 관리자 인증 관련 민감값은 GitHub가 아니라 Apps Script `Script Properties`에서만 관리합니다. 문서에는 운영 절차와 형식만 남기고, 실제 비밀값은 환경 설정에만 존재하도록 유지합니다.
