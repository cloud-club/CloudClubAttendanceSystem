...
> 문서 링크: [docs/History/mission-c-manual-setup.md](./mission-c-manual-setup.md) | [GitHub](https://github.com/cloud-club/CloudClubAttendanceSystem/blob/gh-pages/docs/History/mission-c-manual-setup.md)
...
상세 배경/분기/증상 해석은 `docs/History/019_구글인증_권한오류_트러블슈팅_검증_배포_런북_2026-02-20.md`를 기준으로 합니다.
