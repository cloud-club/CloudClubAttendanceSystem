...
> 문서 링크: [docs/History/011_배포_Secret_API_URL_주입_트러블슈팅_런북.md](./011_배포_Secret_API_URL_주입_트러블슈팅_런북.md) | [GitHub](https://github.com/cloud-club/CloudClubAttendanceSystem/blob/gh-pages/docs/History/011_배포_Secret_API_URL_주입_트러블슈팅_런북.md)
...
| 커밋 | 핵심 변경 | 주요 파일 |
|---|---|---|
| `3880291` | 배포 가드 강화 + `apiInfo` 기반 호환성 체크 + 변수탭 차단 로직 | `.github/workflows/deploy-gh-pages.yml`, `Code.gs`, `web/admin/admin.js` |
| `b085ea9` | `env.js`/`config.js` 병합 우선순위 보정, API_BASE_URL 장애 수정 | `web/shared/env.js`, `web/shared/config.js`, `web/shared/api-jsonp.js` |
| `ddf07dd` (`main`) | 기본 브랜치에 workflow 추가(수동실행 버튼 노출 기반) | `.github/workflows/deploy-gh-pages.yml` |
| `6cacb9d` | Pages 재배포 트리거 커밋 | `.` |
...
## 관련 문서
- [docs/History/005_관리자기능_확장_연대기_2026-02-18.md](./005_관리자기능_확장_연대기_2026-02-18.md) | [GitHub](https://github.com/cloud-club/CloudClubAttendanceSystem/blob/gh-pages/docs/History/005_관리자기능_확장_연대기_2026-02-18.md)
...
- [docs/History/014_시즌업로드_파일정규화_및_파싱트러블슈팅_런북.md](./014_시즌업로드_파일정규화_및_파싱트러블슈팅_런북.md) | [GitHub](https://github.com/cloud-club/CloudClubAttendanceSystem/blob/gh-pages/docs/History/014_시즌업로드_파일정규화_및_파싱트러블슈팅_런북.md)
