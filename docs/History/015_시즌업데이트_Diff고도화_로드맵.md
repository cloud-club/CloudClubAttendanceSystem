...
> 문서 링크: [docs/History/015_시즌업데이트_Diff고도화_로드맵.md](./015_시즌업데이트_Diff고도화_로드맵.md) | [GitHub](https://github.com/cloud-club/CloudClubAttendanceSystem/blob/gh-pages/docs/History/015_시즌업데이트_Diff고도화_로드맵.md)
...
| 커밋 | 핵심 변경 | 주요 파일 |
|---|---|---|
| `50d3170` | 업로드·스키마 v2 기반 토대 구축 | `Code.gs`, `web/admin/admin.js` |
| `0424193` | update/diff 승인 플로우 도입 | `Code.gs`, `web/admin/admin.js` |
| `fbae7f5` | 업데이트 모드 보정 및 diff 통합 | `Code.gs`, `web/admin/admin.js` |
| `cdb3729` | OB 포함 정책 반영 | `Code.gs`, `web/admin/admin.js` |
| `e55537a` | active 세션 복구/중단, Diff UI 가시성 강화 | `Code.gs`, `web/admin/admin.js`, `web/admin/index.html` |
...
- [docs/History/002_시스템_기술_레퍼런스.md](./002_시스템_기술_레퍼런스.md) | [GitHub](https://github.com/cloud-club/CloudClubAttendanceSystem/blob/gh-pages/docs/History/002_시스템_기술_레퍼런스.md)
