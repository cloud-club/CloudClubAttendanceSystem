...
> 문서 링크: [docs/History/mission-auth-plan.md](./mission-auth-plan.md) | [GitHub](https://github.com/cloud-club/CloudClubAttendanceSystem/blob/gh-pages/docs/History/mission-auth-plan.md)
