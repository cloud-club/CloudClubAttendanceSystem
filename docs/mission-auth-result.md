...
## 3) 문서 반영
- `/Users/sbu/SBU/CloudClubAttendanceSystem/docs/mission-auth-plan.md` 신규 작성
- OAuth 전환/레거시 제거 반영:
  ...
  - `/Users/sbu/SBU/CloudClubAttendanceSystem/docs/003_구글시트에서_깃허브페이지스_마이그레이션_기록.md`
  - `/Users/sbu/SBU/CloudClubAttendanceSystem/docs/004_세션_리다이렉트_ORB_이슈_해결_기록.md`
  - `/Users/sbu/SBU/CloudClubAttendanceSystem/docs/012_운영자_개발자_통합_검증체크리스트.md`

## 4) 검증 결과
- `cp /Users/sbu/SBU/CloudClubAttendanceSystem/Code.gs /tmp/Code_gs_check.js && node --check /tmp/Code_gs_check.js` 통과
- `node --check /Users/sbu/SBU/CloudClubAttendanceSystem/web/admin/admin.js` 통과
- `node --check /Users/sbu/SBU/CloudClubAttendanceSystem/web/shared/api-jsonp.js` 통과
- `node --check /Users/sbu/SBU/CloudClubAttendanceSystem/web/student/student.js` 통과
