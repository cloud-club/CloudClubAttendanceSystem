...
const SESSION_HEADER_NOTE_MARKER = '[CloudClub 일정 메타 v1]';
const SCHEDULE_EVENT_NAME_MAX_CODE_POINTS = 80;
...
const API_VERSION = '2026.07.14-v6.3';
...
const ACTION_ACCESS_LEVELS = Object.freeze({
  ...
  studentSchedule: ACTION_ACCESS_PUBLIC,
